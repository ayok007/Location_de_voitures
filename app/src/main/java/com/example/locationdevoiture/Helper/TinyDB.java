...
public class TinyDB {
    ...
    public ArrayList<Cars> getListObject(String key){
        Gson gson = new Gson();

        ArrayList<String> objStrings = getListString(key);
        ArrayList<Cars> playerList =  new ArrayList<Cars>();

        for(String jObjString : objStrings){
            Cars player  = gson.fromJson(jObjString,  Cars.class);
    ...
    public void putListObject(String key, ArrayList<Cars> playerList){
        checkForNullKey(key);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<String>();
        for(Cars player: playerList){
